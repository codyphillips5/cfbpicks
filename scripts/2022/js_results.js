...
var select = `
<button onclick='getResultsByWeek(12);return false;' id='all' class='btn btn-secondary active'>Week 12</button>
<button onclick='getResultsByWeek(11);return false;' id='all' class='btn btn-secondary'>Week 11</button>
