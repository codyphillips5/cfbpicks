...
var week = 0;
if (week === 0) {
	document.getElementById("week-title").innerHTML = `<h2>🚨 🏈 TESTING 🚨</h2><h4>This is a test of the system for Week 0</h4><h4>Come back Week 1 (week of 8/30) for pick submission and the start of the season!</h4>`;
}
else if (week === 15) {
