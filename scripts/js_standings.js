...
$.when(getStandings, getUsers).then(function(){
	var tableStart = `<table class="table table-hover" id="standings-table"><thead><tr><th scope="col">Name</th><th scope="col">Week 1</th><th scope="col">Week 2</th><th scope="col">Week 3</th><th scope="col">Week 4</th><th scope="col">Week 5</th><th scope="col">Week 6</th><th scope="col">Week 7</th><th scope="col">Week 8</th><th scope="col">Week 9</th><th scope="col">Week 10</th><th scope="col" class="active">Total</th></tr></thead><tbody>`;
	...
	for (var key in standings) {
		for (var i = 0; i < standings[key].length; i++) {
			...
			for(var stand = 1; stand <= 10; stand++) {
